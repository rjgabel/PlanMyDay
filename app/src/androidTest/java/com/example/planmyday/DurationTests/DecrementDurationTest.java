...
public class DecrementDurationTest {
    ...
    public void decrementDuration() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.day), withText("5 days"),
                        ...
                        isDisplayed()));
        textView.check(matches(withText("5 days")));

        ViewInteraction materialTextView5 = onView(
                allOf(withId(R.id.subtractButton), withText("─"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.day), withText("4 days"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView2.check(matches(withText("4 days")));
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.day), withText("3 days"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView3.check(matches(withText("3 days")));
        ...
        ViewInteraction textView4 = onView(
                allOf(withId(R.id.day), withText("2 days"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView4.check(matches(withText("2 days")));
        ...
        ViewInteraction textView5 = onView(
                allOf(withId(R.id.day), withText("1 day"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView5.check(matches(withText("1 day")));
        ...
        ViewInteraction textView6 = onView(
                allOf(withId(R.id.day), withText("1 day"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView6.check(matches(withText("1 day")));
    }

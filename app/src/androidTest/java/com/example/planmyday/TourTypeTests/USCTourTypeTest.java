...
public class USCTourTypeTest {
    ...
    public void uSCTourType() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tourType), withText("USC Tour"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(withText("USC Tour")));
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.tourType), withText("USC Tour"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView2.check(matches(withText("USC Tour")));
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.itinerary), withText("USC Itinerary"),
                        withParent(allOf(withId(R.id.slidingPanel),
                                withParent(withId(R.id.sliding_layout)))),
                        isDisplayed()));
        textView3.check(matches(withText("USC Itinerary")));
    }
